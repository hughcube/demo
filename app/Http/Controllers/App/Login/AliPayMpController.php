...
class AliPayMpController extends Controller
{
    /**
    ...
    {
        $session = $this->code2session($this->getRequest()->getClientAppid(), strval($this->p('code')));
    ...
    protected function code2session(mixed $appid, string $code): PayCollection
    {
